...
public class AncientGiantPassiveBonusesAbility extends PassiveStatBonusAbility {
    ...
    public AncientGiantPassiveBonusesAbility(AbilityCore<AncientGiantPassiveBonusesAbility> core) {
        super(core);
        this.pushStaticAttribute(ModEntityAttributes.SIZE, new AttributeModifier(UUID.fromString("4b60ab34-0a3e-4c67-8166-84ed65c70d0e"), "Ancient Giant Height modifier", 30, AttributeModifier.Operation.ADDITION));
        ...
        this.pushStaticAttribute(Attributes.MOVEMENT_SPEED, new AttributeModifier(UUID.fromString("4b61ab34-0b3e-4c67-81f6-84ed65c70d0e"), "Ancient Giant Speed modifier", 3, AttributeModifier.Operation.ADDITION));
        ...
        AttributeModifier reachModifier = new AttributeModifier(UUID.fromString("4064ac34-0d3a-4c67-81f6-84edf5c75d0e"), "Ancient Giant Reach modifier", 75, AttributeModifier.Operation.ADDITION);
