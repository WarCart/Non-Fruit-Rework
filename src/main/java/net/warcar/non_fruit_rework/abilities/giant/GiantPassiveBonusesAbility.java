...
public class GiantPassiveBonusesAbility extends PassiveStatBonusAbility {
    ...
    public GiantPassiveBonusesAbility(AbilityCore<GiantPassiveBonusesAbility> core) {
        super(core);
        this.pushStaticAttribute(ModEntityAttributes.SIZE, new AttributeModifier(UUID.fromString("4b60ab34-0a3e-4c67-8166-84ed65c70d0e"), "Giant Height modifier", 10, AttributeModifier.Operation.ADDITION));
        ...
        this.pushStaticAttribute(Attributes.MOVEMENT_SPEED, new AttributeModifier(UUID.fromString("4b61ab34-0b3e-4c67-81f6-84ed65c70d0e"), "Giant Speed modifier", 1, AttributeModifier.Operation.ADDITION));
        ...
        AttributeModifier reachModifier = new AttributeModifier(UUID.fromString("4064ac34-0d3a-4c67-81f6-84edf5c75d0e"), "Giant Reach modifier", 25, AttributeModifier.Operation.ADDITION);
    ...
    private static boolean canUnlock(LivingEntity entity) {
        return QuestHelper.isTrueRace(entity, "giant");
    }
