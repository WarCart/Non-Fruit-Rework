...
public class JudgeEntity extends ScientistEntity {
    public static final EntityType<JudgeEntity> INSTANCE = WyRegistry.createEntityType(JudgeEntity::new).sized(1, 3).build("");

    public JudgeEntity(EntityType type, World world) {
        super(type, world, "judge");
    ...
    public List<QuestId> getAvailableQuests(PlayerEntity playerEntity) {
        return QuestHelper.getQuestsSorted(playerEntity, ModQuests.GEN_MODIFICATION_QUESTS);
    }
}
